...
import com.example.quizappwithfirebase.databinding.QuizItemRecyclerRowBinding
        ...
        fun bind(model: QuizModel){
            binding.apply {
                ...
                root.setOnClickListener {
                    val intent = Intent(root.context, QuizScreen::class.java)
                    QuizScreen.questionModelList = model.questionList
                    QuizScreen.time = model.time
